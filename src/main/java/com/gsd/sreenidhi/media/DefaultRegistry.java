 ...
 */
package com.gsd.sreenidhi.media;
...
import static com.gsd.sreenidhi.media.AudioFormatKeys.*;
...
public class DefaultRegistry extends Registry {
    ...
    protected void init() {
        ...
        putCodec(
                ...
                "com.gsd.sreenidhi.media.anim.BitmapCodec");
        ...
        putBidiCodec(
                ...
                "com.gsd.sreenidhi.media.avi.AVIPCMAudioCodec");
        putBidiCodec(
        ...
        putCodec(
                ...
                "com.gsd.sreenidhi.media.quicktime.QuickTimePCMAudioCodec");
        putCodec(
                new Format(MediaTypeKey, MediaType.AUDIO, MimeTypeKey, MIME_JAVA, EncodingKey, ENCODING_PCM_UNSIGNED),
                new Format(MediaTypeKey, MediaType.AUDIO, MimeTypeKey, MIME_QUICKTIME, EncodingKey, ENCODING_QUICKTIME_TWOS_PCM),
                "com.gsd.sreenidhi.media.quicktime.QuickTimePCMAudioCodec");
        ...
        putReader(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_AVI), "com.gsd.sreenidhi.media.avi.AVIReader");
        putReader(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_QUICKTIME), "com.gsd.sreenidhi.media.quicktime.QuickTimeReader");
        putReader(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_ANIM), "com.gsd.sreenidhi.media.anim.ANIMReader");
        putWriter(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_AVI), "com.gsd.sreenidhi.media.avi.AVIWriter");
        putWriter(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_QUICKTIME), "com.gsd.sreenidhi.media.quicktime.QuickTimeWriter");
        putWriter(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_ANIM), "com.gsd.sreenidhi.media.anim.ANIMWriter");
